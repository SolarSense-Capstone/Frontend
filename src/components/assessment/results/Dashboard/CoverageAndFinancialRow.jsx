        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100 flex flex-col justify-center">
                ...
                <div className="relative w-full h-4 bg-gray-100 rounded-full overflow-hidden mb-4">
                    <div
                        className="absolute top-0 left-0 h-full bg-[#2E7D32] rounded-full transition-all duration-1000 ease-out"
                ...
                <div className="flex gap-8 z-10 relative">
                    ...
                    <div>
                        <p className="text-xl font-bold leading-none mb-1">
                            {data.system_cost && data.monthly_savings
                                ? (data.system_cost / (data.monthly_savings * 12)).toFixed(1)
                                : '—'} yrs
                        </p>
                        <p className="text-[10px] uppercase font-bold opacity-70 tracking-widest">Payback (approx.)</p>
                    </div>
                </div>
            </div>
